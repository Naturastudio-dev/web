...
const ContactForm = () => {
  return (
    <form className="flex flex-col gap-4 bg-secondary-50/90 rounded-2xl flex-1 w-full max-w-[600px] p-4">
      ...
      <div className="flex flex-col">
        ...
        <Datepicker name="date" id="date" minDate={new Date()} />
      </div>

      <div className="grid md:grid-rows-2">
        <div className="flex flex-col relative">
          <label htmlFor="contact">¿Cómo podría contactarte?</label>
          <Dropdown label="Selecciona una opción" name="contact" id="contact">
